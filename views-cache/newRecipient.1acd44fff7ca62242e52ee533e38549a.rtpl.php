<?php if(!class_exists('Rain\Tpl')){exit;}?>
    <div class="newRecipientPageContent">
        <div class="formRecipientBox">
            ...
            <form action="#" method="post" id="formRecipients">
                <div class="recipientField">
                    <label for="name"><h6 class="recipientLabel">Nome:</h6></label>
                    <input type="text" name="name" class="recipientInput" placeholder="Ex: Fulano De Tal" required>
                </div>
                <div class="recipientField">
                    <label for="email"><h6 class="recipientLabel">Email:</h6></label>
                    <input type="text" name="email" class="recipientInput" placeholder="Ex: fulano@email.com" required>
                </div>
                <div class="recipientField">
                    <label for="tag"><h6 class="recipientLabel">Tag:</h6></label>
                    <input type="text" name="tag" class="recipientInput" placeholder="Cliente" id="lastInput" required>
                </div>
