<?php if(!class_exists('Rain\Tpl')){exit;}?><div class="templateSendContent">
    <form action="/templates/<?php echo htmlspecialchars( $template["idTemplate"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/send" class="templateSend" method="post">
        <input type="hidden" name="nameTemplate" value="<?php echo htmlspecialchars( $template["nameTemplate"], ENT_COMPAT, 'UTF-8', FALSE ); ?>"/>
        
        <div class="sendContainer">
            <h2 class="sendBlueTitle">Assunto:</h2>
            <div class="sendField">
                <label for="subject"><h6 class="sendLabel">Assunto:</h6></label>
        ...
        <div class="sendContainer">
            ...
            <div class="sendField">
                <label for="name"><h6 class="sendLabel">Nome:</h6></label>
                <input type="text" name="nameFrom" class="sendInput" placeholder="Ex: Fulano De Tal" required>
            </div>
        ...
        <div class="recipients-send">
            ...
            <div class="recipient">
                <!-- <input type="hidden" name="nameRecipient" value="<?php echo htmlspecialchars( $value1["nameRecipient"], ENT_COMPAT, 'UTF-8', FALSE ); ?>"/> -->
